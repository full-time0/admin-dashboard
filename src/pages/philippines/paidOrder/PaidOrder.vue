        ...
        <a-form :form="form" layout="horizontal">
          <div :class="advanced ? null: 'fold'">
            <a-row>
              ...
              <a-col :md="8" :sm="24">
                <a-form-item
                  :label="$ta('process|status')"
                  :labelCol="{span: 5}"
                  :wrapperCol="{span: 18, offset: 1}"
                >
                  <a-select
                    v-decorator="['processStatus', {rules: [{ required: false}]}]"
                    :placeholder="$ta('select|process|status')"
                  >
              ...
              <a-col :md="8" :sm="24">
                <a-form-item
                  :label="$ta('transfer|amount')"
                  :labelCol="{span: 5}"
                  :wrapperCol="{span: 18, offset: 1}"
                >
                  <a-input 
                    :placeholder="$ta('input|transfer|amount')" 
                    v-decorator="['transferAmount', {rules: [{ required: false}]}]"
                  />
                </a-form-item>
              </a-col>
            </a-row>
              ...
              <a-col :md="8" :sm="24">
                ...
                >
                  <a-input 
                    ...
                    v-decorator="['receiptAccount', {rules: [{ required: false}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
            ...
            <a-row v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item
                  :label="$ta('process|time')"
                  :labelCol="{span: 5}"
                  :wrapperCol="{span: 18, offset: 1}"
                >
                  <a-range-picker 
                    style="width: 100%"
                    v-decorator="['processTime', {rules: [{ required: false}]}]"
                  />
                </a-form-item>
              </a-col>
            </a-row>
