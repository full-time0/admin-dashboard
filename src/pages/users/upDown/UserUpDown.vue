      ...
      <div>
        ...
        >
          ...
          <div slot="action" slot-scope="{record}">
            <a @click="showOperateModal(record.key, 'gift')" style="margin-right: 8px">
              <a-icon type="gift"/>{{$t('giveGift')}}
            </a>
            <a @click="showOperateModal(record.key, 'up')" style="margin-right: 8px">
              <a-icon type="arrow-up"/>{{$t('up')}}
            </a>
            <a @click="showOperateModal(record.key, 'down')" style="margin-right: 8px">
              <a-icon type="arrow-down"/>{{$t('down')}}
            </a>
          </div>
        </standard-table>
      </div>
    </a-card>
    <operate-modal :visible="isVisible" :id="userID" :which="which"></operate-modal>
  </div>
</template>
...
export default {
  name: 'UserUpDown',
  i18n: require('./i18n'),
  components: {StandardTable, OperateModal},
  data () {
    return {
